...
const Main = () => {
  ...
  const [show4, setShow4] = useState(false);
    ...
    const cardTab = [
      ...
      { title: "VOLLEY BALL LIGUE REGIONALE GRAND EST", link: "/Info/42", imgSrc: volleyBall, linkClass: `hidden ${show2 ? "show2" : ""}`, divClass: "card quarante-trois", h1Class: "angled-shadow" },
      { title: "UGSEL 54", link: "/Info/43", imgSrc: ugsel, linkClass: `hidden ${show2 ? "show2" : ""}`, divClass: "card quarante-quatre", h1Class: "angled-shadow" }
    ];
